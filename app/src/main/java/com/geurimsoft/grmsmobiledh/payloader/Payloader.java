...
public class Payloader extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, this.spinnerArray);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_product.setAdapter(spinnerAdapter);
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.product_pick:
                ...
                spinner_product.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
                {
                    ...
                    {
                        //선택된 품목으로 AppConfig의 product_pick_use 변경
            ...
            case R.id.time_pick:
                ...
                spinner_time.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
                {
                    ...
                    public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
                    {
                        // 선택한 position 값+1 = n 분, 60000 = 1분으로 AppConfig의 time_pick_use 변경
                        GSConfig.time_pick_use = (position+1)*60000;
                    }
