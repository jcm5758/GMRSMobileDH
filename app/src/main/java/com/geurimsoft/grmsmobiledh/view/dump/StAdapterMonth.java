...
public class StAdapterMonth extends BaseAdapter
{
    ...
    public StAdapterMonth(Context _context, GSDumpMonth serviceData)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        StAdapterMonth.ViewHolder holder;

        if (convertView == null)
        {

            holder = new StAdapterMonth.ViewHolder();
        ...
        {
            holder = (StAdapterMonth.ViewHolder) convertView.getTag();
        }
